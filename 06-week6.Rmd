...
```{r, rstudio, echo=FALSE, out.width="90%", fig.cap="R Studio Interfacte",fig.align='center'}
knitr::include_graphics("images/06_rstudio.png")
``` 
...
```{r, run, echo=FALSE, out.width="90%", fig.cap="Run Button",fig.align='center'}
knitr::include_graphics("images/06_run.png")
``` 
...
```{r, bluearrow, echo=FALSE, out.width="90%", fig.cap="Loading a Data Frame",fig.align='center'}
knitr::include_graphics("images/06_bluearrow.png")
``` 
