...
```{r, soppsnap, echo=FALSE, out.width="75%", fig.cap="The Stanford Open Policing Project Data",fig.align='center'}
...
```{r, population, echo=FALSE, out.width="60%", fig.cap="Racial Composition of Traffic Stops and Population",fig.align='center'}
...
```{r, veil2, echo=FALSE, out.width="75%", fig.cap="The Intertwilight Period",fig.align='center'}
knitr::include_graphics("images/03_veil2.png")
```
...
```{r, samename, echo=FALSE, out.width="60%", fig.cap="Example of Merge with Different Names for Matching Varaibles",fig.align='center'}
