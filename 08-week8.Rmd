...
```{r, hist1, echo=F, eval=T, out.width="90%", fig.cap="Histogram of Average Pollution Levels Across Cities Part 1",fig.align='center'}
hist(pm_bycity$meanpm10)
```
...
```{r, hist2, echo=F, eval=T, out.width="90%", fig.cap="Histogram of Average Pollution Levels Across Cities Part 2",fig.align='center'}
hist(pm_bycity$meanpm10, 
     xlab="Mean PM10", 
     ylab="Frequency", 
     main="Mean PM10 by City")
...
Next, we are going to visualize the data in an alternative way: using a box plot. To understand box plots theoretically, we are going to look at ages of Olympians for two different sports: Women's Gymnastics and Men's Curling. This box plot appears in Figure \@ref(fig:box1) below.

```{r, box1, echo=FALSE, out.width="90%", fig.cap="Boxplot of Ages for Different Olympic Sports",fig.align='center'}
knitr::include_graphics("images/04_boxplot.png")
```
...
```{r, box2, echo=FALSE, out.width="90%", fig.cap="Understanding the Box",fig.align='center'}
knitr::include_graphics("images/04_boxplot_percentiles.png")
```
...
```{r, box2, echo=FALSE, out.width="90%", fig.cap="Understanding the Whiskers",fig.align='center'}
knitr::include_graphics("images/04_boxplot_whiskers.png")
```
