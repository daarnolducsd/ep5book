...
```{r, hist1, echo=F, eval=T, out.width="80%", fig.cap="Histogram of Average Pollution Levels Across Cities Part 1",fig.align='center'}
hist(pm_bycity$meanpm10)
```
...
```{r, hist2, echo=F, eval=T, out.width="80%", fig.cap="Histogram of Average Pollution Levels Across Cities Part 2",fig.align='center'}
hist(pm_bycity$meanpm10, 
     xlab="Mean PM10", 
     ylab="Frequency", 
     main="Mean PM10 by City")
...
```{r, hist3, echo=F, eval=T, out.width="90%", fig.cap="Histogram of Average Pollution Levels Across Cities Part 3",fig.align='center'}
par(mfrow=c(1,2))
...
```{r, echo = TRUE, eval = TRUE, out.width="90%"}
...
```{r, echo=TRUE, eval=F, out.width="80%"}
plot(pm_byday$T, pm_byday$meanpm10, 
     xlab="Days After Automation",
     ylab="Mean PM10", main="Automation and Mean PM10",
     pch=16, ylim=c(0,300))
...
```{r, echo = TRUE, eval = TRUE, out.width="85%"}
...
```{r, box1, echo=FALSE, out.width="75%", fig.cap="Boxplot of Ages for Different Olympic Sports",fig.align='center'}
knitr::include_graphics("images/08_boxplot.png")
```
...
```{r, box2, echo=FALSE, out.width="75%", fig.cap="Understanding the Box",fig.align='center'}
knitr::include_graphics("./images/08_boxplot_percentiles.png")
```
...
```{r, box3, echo=FALSE, out.width="75%", fig.cap="Understanding the Whiskers",fig.align='center'}
knitr::include_graphics("./images/08_boxplot_whisker.png")
```
...
```{r,badbar,echo=FALSE, eval=TRUE,out.width="75%"}
ggplot(pm_bycity, aes(x=factor(phase))) + 
  geom_bar(stat="count")
```
...
```{r,goodbar,echo=TRUE, eval=TRUE,out.width="75%"}
ggplot(pm_bycity, aes(x=factor(phase))) + 
...
```{r,coloredbar,echo=TRUE, eval=TRUE,out.width="75%"}
...
```{r,dodgebar,echo=TRUE, eval=TRUE,out.width="75%"}
ggplot(pm_bycity, aes(x=factor(phase),fill=above80)) + 
...
```{r, echo=TRUE, eval=TRUE, out.width="75%", message=FALSE}
