...
```{r, butterfly, echo=FALSE, out.width="80%", fig.cap="The Butterfly Ballot",fig.align='center'}
knitr::include_graphics("images/09_palmballot.png")
``` 
...
```{r, butter1, echo=F, eval=T, out.width="80%", fig.cap="Relationship Between Buchanan and Perot Votes",fig.align='center'}
...
```{r, butter2, echo=F, eval=T, out.width="80%", fig.cap="Relationship Between Buchanan and Perot Votes",fig.align='center'}
ggplot(florida, 
...
```{r, basescatter1, echo=T, eval=T, out.width="80%", fig.cap="Relationship Between Buchanan and Perot Votes",fig.align='center'}
...
```{r, basescatter2, echo=T, eval=T, out.width="80%", fig.cap="Relationship Between Buchanan and Perot Votes",fig.align='center'}
plot(florida$Perot96, florida$Buchanan00, 
     pch=16,
     xlab="Votes for Perot in 1996", 
     ylab="Votes for Buchanan in 2000")
...
```{r, basescatter3, echo=T, eval=T, out.width="80%", fig.cap="Relationship Between Buchanan and Perot Votes",fig.align='center'}
plot(florida$Perot96, florida$Buchanan00, 
     pch=16,
     xlab="Votes for Perot in 1996", 
     ylab="Votes for Buchanan in 2000")
...
```{r, geomscatter, echo=T, eval=T, out.width="80%", fig.cap="Relationship Between Buchanan and Perot Votes",fig.align='center'}
ggplot(florida, mapping=aes(x=Perot96, y=Buchanan00)) + 
  geom_point() + 
  xlab("Votes for Perot in 1996") + 
  ylab("Votes for Buchanan in 2000") + 
...
florida %>% select(county,Buchanan00,predBuchanan00,residuals)
```
...
```{r, echo=FALSE, eval=TRUE}
florida %>% select(county,Buchanan00,predBuchanan00,residuals) %>% arrange(desc(abs(residuals)))
```
