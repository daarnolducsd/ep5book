...
knitr::include_graphics("images/02_main.png")
```
...
```{r, maincopy, echo=FALSE, out.width="75%", fig.cap="Opening a New Do-File in Stata",fig.align='center'}
knitr::include_graphics("images/02_main copy.png")
```

Figure \@ref(fig:dofileicon) shows a larger version of the do-file icon.

```{r, dofileicon, echo=FALSE, out.width="75%", fig.cap="Do-File Icon",fig.align='center'}
...
```{r, dofile1, echo=FALSE, out.width="75%", fig.cap="Blank Do-File",fig.align='center'}
...
```{r, dofile7, echo=FALSE, out.width="75%", fig.cap="Executing Lines 1 and 2",fig.align='center'}
...
```{r, dofile8, echo=FALSE, out.width="75%", fig.cap="Executing Lines 2 and 3",fig.align='center'}
...
```{r, dofile5, echo=FALSE, out.width="75%", fig.cap="Saving A Do-File",fig.align='center'}
knitr::include_graphics("images/02_dofile4.png")
```
...
```{r, brca, echo=FALSE, out.width="60%", fig.cap="Generating A Binary Indicator for California Colleges",fig.align='center'}
