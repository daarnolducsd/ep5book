...
```{r, oi, echo=FALSE, out.width="100%", fig.cap="New York Times Graphic on Opportunity Insights",fig.align='center'}
knitr::include_graphics("images/02_oi.png")
```
...
opts_p <- c(
   ...
   answer = "Lower earnings than 67 percent of individuals ",
...
```{r, gui, echo=FALSE, out.width="100%", fig.cap="Stata Graphical User Interface",fig.align='center'}
knitr::include_graphics("images/02_main copy.png")
```
...
```{r, main, echo=FALSE, out.width="75%", fig.cap="Variables Window Example",fig.align='center'}
knitr::include_graphics("images/02_example_income.png")
```
...
```{r, helpdisplay, echo=FALSE, out.width="100%", fig.cap="Variables Window Example",fig.align='center'}
knitr::include_graphics("images/02_display_help_file.png")
```
...
```{r, helloerror, echo=FALSE, out.width="50%", fig.cap="Forgetting Quotation Marks When Referencing Strings",fig.align='center'}
knitr::include_graphics("images/02_hello_error.png")
```
...
```{r, maincopy, echo=FALSE, out.width="100%", fig.cap="Opening a New Do-File in Stata",fig.align='center'}
knitr::include_graphics("images/02_main copy.png")
```

Figure \@ref(fig:dofileicon) shows a larger version of the do-file icon.

```{r, dofileicon, echo=FALSE, out.width="100%", fig.cap="Do-File Icon",fig.align='center'}
knitr::include_graphics("images/02_icon.png")
```
...
```{r, dofile1, echo=FALSE, out.width="100%", fig.cap="Blank Do-File",fig.align='center'}
knitr::include_graphics("images/02_dofile1.png")
```
...
```{r, dofile2, echo=FALSE, out.width="100%", fig.cap="Display 2+2 in a Do-File",fig.align='center'}
knitr::include_graphics("images/02_dofile2.png")
```
...
```{r, dofile7, echo=FALSE, out.width="100%", fig.cap="Executing Lines 1 and 2",fig.align='center'}
knitr::include_graphics("images/02_dofile7.png")
```

```{r, dofile8, echo=FALSE, out.width="100%", fig.cap="Executing Lines 2 and 3",fig.align='center'}
knitr::include_graphics("images/02_dofile8.png")
```
...
```{r, dofile5, echo=FALSE, out.width="100%", fig.cap="Saving A Do-File",fig.align='center'}
knitr::include_graphics("images/02_dofile5.png")
```
...
```{r, hierarchy, echo=FALSE, out.width="100%", fig.cap="Example Structure of a Folder Hierarchy for this Course",fig.align='center'}
knitr::include_graphics("images/02_hierarchy.png")
```
...
```{r, describe, echo=FALSE, out.width="100%", fig.cap="Describe Command",fig.align='center'}
knitr::include_graphics("images/02_describe_ex.png")
```
...
```{r, browseex, echo=FALSE, out.width="100%", fig.cap="Browse Command",fig.align='center'}
knitr::include_graphics("images/02_browse_ex.png")
```
...
```{r, brca, echo=FALSE, out.width="100%", fig.cap="Generating A Binary Indicator for California Colleges",fig.align='center'}
knitr::include_graphics("images/02_br.png")
```
...
```{r, forgotdoubleequals, echo=FALSE, out.width="100%", fig.cap="Forgetting Double Equals  When Testing Equality",fig.align='center'}
knitr::include_graphics("images/02_error1.png")
```
...
```{r, forgotquotes, echo=FALSE, out.width="100%", fig.cap="Forgetting Quotation Marks When Referencing Strings",fig.align='center'}
knitr::include_graphics("images/02_error2.png")
```
...
```{r, sumhelp, echo=FALSE, out.width="75%", fig.cap="Help File for the Summarize Command",fig.align='center'}
knitr::include_graphics("images/02_sum_help.png")
```
...
```{r, histtestscore, echo=FALSE, out.width="75%", fig.cap="Histogram of Test Scores",fig.align='center'}
knitr::include_graphics("images/02_hist_ex.png")
```
...
```{r, histmovies, echo=FALSE, out.width="75%", fig.cap="Histogram of Rotten Tomatoes Scores for Movies Released in 2015",fig.align='center'}
knitr::include_graphics("images/02_movies1.png")
```
...
```{r, athleteages, echo=FALSE, out.width="75%", fig.cap="Histogram of Olympic Athlete Ages",fig.align='center'}
knitr::include_graphics("images/02_athletes.png")
```
...
```{r, Chipotle, echo=FALSE, out.width="100%", fig.cap="Histogram of Calories of Chipotle Meals",fig.align='center'}
knitr::include_graphics("images/02_chipotle.png")
```
...
```{r, mobilityhist1, echo=FALSE, out.width="85%", fig.cap="Histogram of College Mobility Rates",fig.align='center'}
knitr::include_graphics("images/02_hist1.png")
```
...
```{r, mobilityhist2, echo=FALSE, out.width="85%", fig.cap="Histogram of College Mobility Rates (Changing the Vertical Axis)",fig.align='center'}
knitr::include_graphics("images/02_hist2.png")
```
...
```{r, mobilityhist6, echo=FALSE, out.width="85%", fig.cap="Histogram of College Mobility Rates (Changing the Number of Bins)",fig.align='center'}
knitr::include_graphics("images/02_hist6.png")
```
...
```{r, mobilityhist7, echo=FALSE, out.width="85%", fig.cap="Histogram of College Mobility Rates (Changing the Width of the Bins)",fig.align='center'}
knitr::include_graphics("images/02_hist7.png")
```
...
```{r, histae2, echo=FALSE, out.width="85%", fig.cap="Histogram of College Mobility Rates (Changing the Color of the Bars)",fig.align='center'}
knitr::include_graphics("images/02_histae2.png")
```
...
```{r, histae3, echo=FALSE, out.width="85%", fig.cap="Histogram of College Mobility Rates (Adding a Title)",fig.align='center'}
knitr::include_graphics("images/02_histae3.png")
```
...
```{r, histae4, echo=FALSE, out.width="85%", fig.cap="Histogram of College Mobility Rates (Changing Axis Labels)",fig.align='center'}
knitr::include_graphics("images/02_histae4.png")
```
...
```{r, histae5, echo=FALSE, out.width="85%", fig.cap="Histogram of College Mobility Rates (Changing Background)",fig.align='center'}
knitr::include_graphics("images/02_histae5.png")
```
...
```{r, histae7, echo=FALSE, out.width="85%", fig.cap="Histogram of College Mobility Rates (Adding Vertical Line with Text)",fig.align='center'}
knitr::include_graphics("images/02_histae7.png")
```
...
```{r, avss, echo=FALSE, out.width="85%", fig.cap="Access vs. Success Across Colleges",fig.align='center'}
knitr::include_graphics("images/02_scatter.png")
```
...
```{r, ucsdaccess, echo=FALSE, out.width="85%", fig.cap="Trends in Access at UCSD",fig.align='center'}
knitr::include_graphics("images/02_trends.png")
```
...
```{r, ucsdsess, echo=FALSE, out.width="85%", fig.cap="Trends in Success at UCSD by Quintile",fig.align='center'}
knitr::include_graphics("images/02_trends2.png")
```
...
```{r, topmobility, echo=FALSE, out.width="85%", fig.cap="Schools with the Highest Mobility Rates",fig.align='center'}
knitr::include_graphics("images/02_top10.png")
```
...
```{r, trendstopmobility, echo=FALSE, out.width="85%", fig.cap="Trends in Schools with the Highest Mobility Rates",fig.align='center'}
knitr::include_graphics("images/02_trends_selected.png")
```
