...
```{r, msdescribe, echo=FALSE, out.width="90%", fig.cap="Describing the Mindspark Data",fig.align='center'}
knitr::include_graphics("images/04_describe.png")
```
...
question("Increasing test scores from 0.503 to 0.552 is a",
  answer("0.052 percent increase test scores"),
  answer("5.2 percent increase test scores"),
  answer("5.2 percentage point increase in test scores", correct = TRUE),
  answer("0.052 percentage point increase in test scores")
)
```
...
```{r, ctof, echo=FALSE, out.width="90%", fig.cap="Converting Celsius to Fahrenheit",fig.align='center'}
knitr::include_graphics("images/04_ctof.png")
```
...
$$
```{r, hypreg1, echo=FALSE, out.width="90%", fig.cap="Hypothetical Regression",fig.align='center'}
knitr::include_graphics("images/04_reg1.png")
```
...
```{r, hypreg2, echo=FALSE, out.width="90%", fig.cap="Hypothetical Dataset: Finding the Best Fit Line",fig.align='center'}
knitr::include_graphics("images/04_reg2.png")
```

Let's draw a line and then assess whether the fit is good or bad. Consider the line in Figure \@ref(fig:hypreg3).

```{r, hypreg3, echo=FALSE, out.width="90%", fig.cap="Hypothetical Dataset: Finding the Best Fit Line",fig.align='center'}
knitr::include_graphics("images/04_reg4.png")
```
...
```{r, hypreg4, echo=FALSE, out.width="90%", fig.cap="Hypothetical Dataset: Finding the Best Fit Line",fig.align='center'}
knitr::include_graphics("images/04_reg3.png")
```
...
```{r, scatter1, echo=FALSE, out.width="90%", fig.cap="Life Expectancy vs. Average Income (1000s) Across Countries",fig.align='center'}
knitr::include_graphics("images/04_scatter1.png")
```
...
```{r, bestfit1, echo=FALSE, out.width="90%", fig.cap="Life Expectancy vs. Average Income (1000s) Across Countries",fig.align='center'}
knitr::include_graphics("images/04_scatter1p5.png")
```
...
```{r, scatter3, echo=FALSE, out.width="90%", fig.cap="Life Expectancy vs. Log Average Income Across Countries",fig.align='center'}
knitr::include_graphics("images/04_scatter3.png")
```
...
```{r, bestlfit, echo=FALSE, out.width="80%", fig.cap="Life Expectancy vs.Average Income Across Countries",fig.align='center'}
knitr::include_graphics("images/04_best_lfit.png")
```
...
```{stata, eval=T, echo=F, collectcode=TRUE}
reg life_expectancy average_income
```
...
```{r, basicscatter, echo=FALSE, out.width="80%", fig.cap="Assessed Math Grade Level vs. Actual Grade Level ",fig.align='center'}
knitr::include_graphics("images/04_basic.png")
```
...
```{r, improvescatter, echo=FALSE, out.width="80%", fig.cap="Assessed Math Grade Level vs. Actual Grade Level ",fig.align='center'}
knitr::include_graphics("images/04_improved.png")
```
...
```{r, msgtab, echo=FALSE, out.width="80%", fig.cap="Balance Table from Muralidharan, Singh and Ganimian (2019)",fig.align='center'}
knitr::include_graphics("images/04_msg_tab.png")
```
...
```{r, tab1basic, echo=FALSE, out.width="80%", fig.cap="Basic Summary Statistics Table",fig.align='center'}
knitr::include_graphics("images/04_tab1_basic.png")
``` 
...
```{r, tab1balance, echo=FALSE, out.width="80%", fig.cap="Basic Balance Table",fig.align='center'}
knitr::include_graphics("images/04_balance_tab.png")
``` 
...
```{r, tab2balance, echo=FALSE, out.width="80%", fig.cap="Final Balance Table",fig.align='center'}
knitr::include_graphics("images/04_balance_tab_fin.png")
``` 
...
```{r, regtabbasic, echo=FALSE, out.width="80%", fig.cap="Regression Table",fig.align='center'}
knitr::include_graphics("images/04_basic_reg_table.png")
``` 
...
```{r, regcoefs, echo=FALSE, out.width="80%", fig.cap="Regression Table: Coefficient Estimates",fig.align='center'}
knitr::include_graphics("images/04_reg_table_coefs.png")
``` 
...
```{r, regfinal, echo=FALSE, out.width="80%", fig.cap="Final Regression Table",fig.align='center'}
knitr::include_graphics("images/04_reg_table_improved.png")
``` 
...
```{r, dynamic, echo=FALSE, out.width="80%", fig.cap="Dynamic Updating of Mindspark",fig.align='center'}
knitr::include_graphics("images/04_fig.png")
``` 
