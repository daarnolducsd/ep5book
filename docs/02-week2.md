...
<div class='webex-radiogroup' id='radio_VJSXKWAKPV'><label><input type="radio" autocomplete="off" name="radio_VJSXKWAKPV" value=""></input> <span>Lower earnings than 33 percent of individuals</span></label><label><input type="radio" autocomplete="off" name="radio_VJSXKWAKPV" value="answer"></input> <span>Lower earnings than 67 percent of individuals </span></label><label><input type="radio" autocomplete="off" name="radio_VJSXKWAKPV" value=""></input> <span>Higher earnings than 67 Percent of individuals</span></label></div>
...
<div class='webex-radiogroup' id='radio_EXMLRBCDBH'><label><input type="radio" autocomplete="off" name="radio_EXMLRBCDBH" value=""></input> <span>College A</span></label><label><input type="radio" autocomplete="off" name="radio_EXMLRBCDBH" value="answer"></input> <span>College B</span></label><label><input type="radio" autocomplete="off" name="radio_EXMLRBCDBH" value=""></input> <span>They have the same</span></label><label><input type="radio" autocomplete="off" name="radio_EXMLRBCDBH" value=""></input> <span>Not possible to tell</span></label></div>
...
When we load data, the names of the variables in the dataset will appear in the first column. Many times, datasets come with labels that give us more description about the variable. For example, in the figure below there is one variable named ``income`` with the label ``Total Annual Income``. 
