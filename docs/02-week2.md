...
<div class='webex-radiogroup' id='radio_LEKMIBPIOZ'><label><input type="radio" autocomplete="off" name="radio_LEKMIBPIOZ" value=""></input> <span>Lower earnings than 33 percent of individuals</span></label><label><input type="radio" autocomplete="off" name="radio_LEKMIBPIOZ" value="answer"></input> <span>Lower earnings than 67 percent of individuals </span></label><label><input type="radio" autocomplete="off" name="radio_LEKMIBPIOZ" value=""></input> <span>Higher earnings than 67 Percent of individuals</span></label></div>
...
<div class='webex-radiogroup' id='radio_RBMYCIVYZA'><label><input type="radio" autocomplete="off" name="radio_RBMYCIVYZA" value=""></input> <span>College A</span></label><label><input type="radio" autocomplete="off" name="radio_RBMYCIVYZA" value="answer"></input> <span>College B</span></label><label><input type="radio" autocomplete="off" name="radio_RBMYCIVYZA" value=""></input> <span>They have the same</span></label><label><input type="radio" autocomplete="off" name="radio_RBMYCIVYZA" value=""></input> <span>Not possible to tell</span></label></div>
