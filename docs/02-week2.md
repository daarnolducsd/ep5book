...
<div class='webex-radiogroup' id='radio_XYQDVGWCMK'><label><input type="radio" autocomplete="off" name="radio_XYQDVGWCMK" value=""></input> <span>Lower earnings than 33 percent of individuals</span></label><label><input type="radio" autocomplete="off" name="radio_XYQDVGWCMK" value="answer"></input> <span>Lower earnings than 67 percent of individuals </span></label><label><input type="radio" autocomplete="off" name="radio_XYQDVGWCMK" value=""></input> <span>Higher earnings than 67 Percent of individuals</span></label></div>
...
<div class='webex-radiogroup' id='radio_XMXQRIGCCH'><label><input type="radio" autocomplete="off" name="radio_XMXQRIGCCH" value=""></input> <span>College A</span></label><label><input type="radio" autocomplete="off" name="radio_XMXQRIGCCH" value="answer"></input> <span>College B</span></label><label><input type="radio" autocomplete="off" name="radio_XMXQRIGCCH" value=""></input> <span>They have the same</span></label><label><input type="radio" autocomplete="off" name="radio_XMXQRIGCCH" value=""></input> <span>Not possible to tell</span></label></div>
