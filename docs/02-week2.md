...
<div class='webex-radiogroup' id='radio_YFUAANYOKB'><label><input type="radio" autocomplete="off" name="radio_YFUAANYOKB" value=""></input> <span>Lower earnings than 33 percent of individuals</span></label><label><input type="radio" autocomplete="off" name="radio_YFUAANYOKB" value="answer"></input> <span>Lower earnings than 67 percent of individuals </span></label><label><input type="radio" autocomplete="off" name="radio_YFUAANYOKB" value=""></input> <span>Higher earnings than 67 Percent of individuals</span></label></div>
...
<div class='webex-radiogroup' id='radio_TGMPHQJYVL'><label><input type="radio" autocomplete="off" name="radio_TGMPHQJYVL" value=""></input> <span>College A</span></label><label><input type="radio" autocomplete="off" name="radio_TGMPHQJYVL" value="answer"></input> <span>College B</span></label><label><input type="radio" autocomplete="off" name="radio_TGMPHQJYVL" value=""></input> <span>They have the same</span></label><label><input type="radio" autocomplete="off" name="radio_TGMPHQJYVL" value=""></input> <span>Not possible to tell</span></label></div>
