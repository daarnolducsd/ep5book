...
<div class='webex-radiogroup' id='radio_XKTZULNSPQ'><label><input type="radio" autocomplete="off" name="radio_XKTZULNSPQ" value=""></input> <span>State</span></label><label><input type="radio" autocomplete="off" name="radio_XKTZULNSPQ" value=""></input> <span>Year</span></label><label><input type="radio" autocomplete="off" name="radio_XKTZULNSPQ" value=""></input> <span>Individual-year</span></label><label><input type="radio" autocomplete="off" name="radio_XKTZULNSPQ" value="answer"></input> <span>State-year</span></label></div>
...
<div class='webex-radiogroup' id='radio_ASYJSJTFQI'><label><input type="radio" autocomplete="off" name="radio_ASYJSJTFQI" value=""></input> <span>AVERAGE is the wrong function to use</span></label><label><input type="radio" autocomplete="off" name="radio_ASYJSJTFQI" value=""></input> <span>Column C must not be numeric</span></label><label><input type="radio" autocomplete="off" name="radio_ASYJSJTFQI" value="answer"></input> <span>Need to specify equals sign ``=`` before the function</span></label></div>
