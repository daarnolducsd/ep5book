...
knitr::include_graphics("images/05_bin3.png")
```
...
```{r, reglinebin, echo=FALSE, out.width="65%", fig.cap="Regression Line: Refusing Blood Test vs. Share of Years Visited",fig.align='center'}
