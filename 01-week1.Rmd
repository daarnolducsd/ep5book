...
```{r, chocolate, echo=FALSE, out.width="65%", fig.cap="Chocolate Consumption and Nobel Prizes",fig.align='center'}
knitr::include_graphics("images/01_chocolate.png")
```
...
```{r, spurious, echo=FALSE, out.width="100%", fig.cap="Example of a Spurious Correlation from tylervigen.com",fig.align='center'}
knitr::include_graphics("images/01_spurious.png")
```
...
```{r, echo = FALSE}
opts <- c(
   answer = "Ability to randomize individuals across treatment and control",
   "Ability to collect large amounts of data",
   "Ability to following individuals over time",
...
```{r, bsdata, echo=FALSE, out.width="75%", fig.cap="Data From Brownstone and Sadoff (2020)",fig.align='center'}
knitr::include_graphics("images/01_data.png")
```
...
```{r, student, echo=FALSE, out.width="50%", fig.cap="Unit of Observation Example 1",fig.align='center'}
knitr::include_graphics("images/01_student.png")
```
...
```{r, studentterm, echo=FALSE, out.width="55%", fig.cap="Unit of Observation Example 2",fig.align='center'}
knitr::include_graphics("images/01_student_term.png")
```
...
```{r, freeze, echo=FALSE, out.width="100%", fig.cap="Freezing the First Row",fig.align='center'}
knitr::include_graphics("images/01_freeze.png")
```
...
```{r, gdp2020, echo=FALSE, out.width="100%", fig.cap="GDP in 2020",fig.align='center'}
knitr::include_graphics("images/01_gdp2020.png")
```
...
```{r, japan, echo=FALSE, out.width="100%", fig.cap="How to Reference a Cell",fig.align='center'}
knitr::include_graphics("images/01_japan.png")
```
...
```{r, cells, echo=FALSE, out.width="70%", fig.cap="Referencing a Range of Cells",fig.align='center'}
knitr::include_graphics("images/01_cells.png")
```
...
```{r, average1, echo=FALSE, out.width="80%", fig.cap="Computing Average GDP in 2020 (Before Pressing Enter)",fig.align='center'}
knitr::include_graphics("images/01_average1.png")
```
...
```{r, average2, echo=FALSE, out.width="80%", fig.cap="Computing Average GDP in 2020 (After Pressing Enter)",fig.align='center'}
knitr::include_graphics("images/01_average2.png")
```
...
```{r, gdpsumstats, echo=FALSE, out.width="80%", fig.cap="Summary Statistics Table",fig.align='center'}
knitr::include_graphics("images/01_gdp_sum_stats.png")
```
...
opts <- c(
   ...
   answer="Need to specify equals sign ``=`` before the function"
)
```
...
```{r, tf1, echo=FALSE, out.width="100%", fig.cap="Is GDP Greater than 10 in the U.S. Part 1",fig.align='center'}
knitr::include_graphics("images/01_tf1.png")
```
...
```{r, tf2, echo=FALSE, out.width="100%", fig.cap="Is GDP Greater than 10 in the U.S. Part 2",fig.align='center'}
knitr::include_graphics("images/01_tf2.png")
```
...
```{r, fill, echo=FALSE, out.width="100%", fig.cap="Filling in the Formula",fig.align='center'}
knitr::include_graphics("images/01_fill.png")
```
...
```{r, ifex1, echo=FALSE, out.width="100%", fig.cap="Using the IF function (Before Pressing Enter)",fig.align='center'}
knitr::include_graphics("images/01_if1.png")
```
...
```{r, ifex2, echo=FALSE, out.width="100%", fig.cap="Using the IF function (After Pressing Enter)",fig.align='center'}
knitr::include_graphics("images/01_if2.png")
```
...
```{r, passed1, echo=FALSE, out.width="100%", fig.cap="Generating a Passed Variable (Steps 1 and 2)",fig.align='center'}
knitr::include_graphics("images/01_passed1.png")
```
...
```{r, passed2, echo=FALSE, out.width="100%", fig.cap="Generating a Passed Variable (Step 3)",fig.align='center'}
knitr::include_graphics("images/01_passed2.png")
```
...
```{r, sumstats1, echo=FALSE, out.width="100%", fig.cap="Blank Summary Statistics Table",fig.align='center'}
knitr::include_graphics("images/01_sumstats1.png")
```

To compute average age in the dataset we just need to use the ``AVERAGE`` function and reference column C. 

```{r, sumstats2, echo=FALSE, out.width="100%", fig.cap="Average Age",fig.align='center'}
knitr::include_graphics("images/01_sumstats2.png")
```

Average test score is completely analogous to age, but we now reference column F.

```{r, sumstats3, echo=FALSE, out.width="100%", fig.cap="Average Test Score",fig.align='center'}
knitr::include_graphics("images/01_sumstats3.png")
```
...
```{r, fracpassed, echo=FALSE, out.width="100%", fig.cap="Computing the Fraction Passed",fig.align='center'}
knitr::include_graphics("images/01_frac_passed.png")
```
...
```{r, count, echo=FALSE, out.width="100%", fig.cap="Computing Total Observations",fig.align='center'}
knitr::include_graphics("images/01_count.png")
```
...
```{r, pivotfinal, echo=FALSE, out.width="38%", fig.cap="Pivot Table: Pass Rates by Department",fig.align='center'}
knitr::include_graphics("images/01_pivot_final.png")
```
...
```{r, pivot1, echo=FALSE, out.width="100%", fig.cap="Inserting a Pivot Table",fig.align='center'}
knitr::include_graphics("images/01_pivot1.png")
```
...
```{r, pivot3, echo=FALSE, out.width="100%", fig.cap="Selecting a Range for the Pivot Table",fig.align='center'}
knitr::include_graphics("images/01_pivot3.png")
```
...
```{r, pivot4, echo=FALSE, out.width="100%", fig.cap="A Blank Pivot Table",fig.align='center'}
knitr::include_graphics("images/01_pivot4.png")
```
...
```{r, pivot5, echo=FALSE, out.width="100%", fig.cap="Adding DepartmentCode to the Pivot Table",fig.align='center'}
knitr::include_graphics("images/01_pivot5.png")
```
...
```{r, pivot6, echo=FALSE, out.width="100%", fig.cap="Adding DepartmentCode to the Pivot Table",fig.align='center'}
knitr::include_graphics("images/01_pivot6.png")
```

In the Values panel, we want pass rates. We will compute these pass rates from the variable "Passed" 

```{r, pivot7, echo=FALSE, out.width="100%", fig.cap="Adding Passed to the Pivot Table",fig.align='center'}
knitr::include_graphics("images/01_pivot7.png")
```
...
```{r, pivot8, echo=FALSE, out.width="100%", fig.cap="Average Pass Rates",fig.align='center'}
knitr::include_graphics("images/01_pivot7.png")
```
...
```{r, balance, echo=FALSE, out.width="100%", fig.cap="Average Age by Treatment Group",fig.align='center'}
knitr::include_graphics("images/01_age.png")
```
...
```{r, firstresult, echo=FALSE, out.width="50%", fig.cap="Impact of Financial Incentives on Pass Rates",fig.align='center'}
knitr::include_graphics("images/01_result1.png")
```
...
```{r, pivotfield, echo=FALSE, out.width="35%", fig.cap="Pivot Fields",fig.align='center'}
knitr::include_graphics("images/01_pivot_field.png")
```

Figure \@ref(fig:hetresults) displays the results.

```{r, hetresults, echo=FALSE, out.width="75%", fig.cap="Pivot Table Showing Pass Rates by Treatment and Control Across Departments",fig.align='center'}
knitr::include_graphics("images/01_pivot_het_blank.png")
```
...
```{r, pivotchart1, echo=FALSE, out.width="100%", fig.cap="Inserting a Pivot Chart",fig.align='center'}
knitr::include_graphics("images/01_pivot_chart1.png")
```
...
```{r, pivotchart2, echo=FALSE, out.width="25%", fig.cap="Pivot Chart Fields",fig.align='center'}
knitr::include_graphics("images/01_pivot_chart2.png")
```
...
```{r, pivotchart3, echo=FALSE, out.width="100%", fig.cap="Pivot Chart Fields",fig.align='center'}
knitr::include_graphics("images/01_pivot_chart3.png")
```
...
```{r, pivotchart4, echo=FALSE, out.width="50%", fig.cap="Filtering Out Blank",fig.align='center'}
knitr::include_graphics("images/01_pivot_chart4.png")
```

Next, a window will pop up. We can deselect "(blank)" to remove it from the Pivot Table

```{r, pivotchart5, echo=FALSE, out.width="70%", fig.cap="Filtering Out Blank",fig.align='center'}
knitr::include_graphics("images/01_pivot_chart5.png")
```
...
```{r, pivotchart8, echo=FALSE, out.width="70%", fig.cap="Adding a Title",fig.align='center'}
knitr::include_graphics("images/01_pivot_chart8.png")
```
...
```{r, pivotchart9, echo=FALSE, out.width="90%", fig.cap="Adding Axes Titles",fig.align='center'}
knitr::include_graphics("images/01_pivot_chart9.png")
```
...
```{r, pivotchart11, echo=FALSE, out.width="60%", fig.cap="Average Pass Rates by Treatment Arm",fig.align='center'}
knitr::include_graphics("images/01_pivot_chart11.png")
```
...
```{r, advpivot2, echo=FALSE, out.width="60%", fig.cap="Average Pass Rates by Treatment Arm and Department",fig.align='center'}
knitr::include_graphics("images/01_adv_pivot2.png")
```
...
```{r, advpivot3, echo=FALSE, out.width="100%", fig.cap="Average Pass Rates by Treatment Arm and Department",fig.align='center'}
knitr::include_graphics("images/01_adv_pivot3.png")
```
 
Figure \@ref(fig:advpivot3) displays the resulting figure. This is the resulting figure. 

```{r, advpivot4, echo=FALSE, out.width="100%", fig.cap="Average Pass Rates by Treatment Arm and Department",fig.align='center'}
knitr::include_graphics("images/01_adv_pivot4.png")
```
...
```{r, advpivot5, echo=FALSE, out.width="40%", fig.cap="Pivot Chart Fields",fig.align='center'}
knitr::include_graphics("images/01_adv_pivot5.png")
```
...
```{r, advpivot7, echo=FALSE, out.width="100%", fig.cap="Average Pass Rates by Treatment Arm and Department",fig.align='center'}
knitr::include_graphics("images/01_adv_pivot7.png")
```
